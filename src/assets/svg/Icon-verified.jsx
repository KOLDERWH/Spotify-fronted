...
const IconVerified = memo(() => {
    return (
        <svg data-encore-id="verifiedBadge" role="img" aria-hidden="true" viewBox="0 0 24 24" data-testid="verified-icon" class="Svg-sc-ytk21e-0 kPpCsU XWpTterac_80p1pzmH5N"><title>Verified account</title>
